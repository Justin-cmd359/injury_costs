  ...
  return (
    <div style={{ minHeight: "100vh", background: "#09090f", color: "#e0dff5", fontFamily: "'DM Mono',monospace" }}>
      ...
      <div style={{ padding: "32px 40px 64px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(145px,1fr))", gap: 12, marginBottom: 28 }}>
          {[
            ...
            { lbl: "Conditions Beating It", val: "5 of 10", sub: "outpaced wage growth", c: "#e05c6f" },
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 220 }}>
            ...
            <div style={{ fontSize: 13, color: "#c0bfef", lineHeight: 1.75 }}>
              ...
              Over that same period, the cost of treating 5 of 10 major diseases grew <span style={{ color: "#e05c6f", fontWeight: 600 }}>faster still</span> —
      ...
      <div style={{ fontSize: 10, color: "#2a2a3a", textAlign: "center", paddingBottom: 16 }}>
        Sources: BEA Health Care Satellite Account 2000–2021 · BLS/FRED Median Weekly Earnings (LEU0252881500A) · OECD Health Expenditure &amp; Financing 2022 · Richman et al. Health Affairs 2022 · Shrank et al. JAMA 2019 · Berwick et al. Health Affairs 2025
      </div>
    </div>
  );
}
