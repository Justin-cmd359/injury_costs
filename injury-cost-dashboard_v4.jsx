...
const WAGE_GROWTH_2000_2021 = 55;
...
const birCosts = [
  ...
  { country: "Canada", surgical: 22 },
];

// Waste taxonomy — Shrank et al. JAMA 2019 + Berwick 2025
    ...
    <div style={{ minHeight: "100vh", background: "#09090f", color: "#e0dff5", fontFamily: "'DM Mono',monospace" }}>
      ...
      <div style={{ padding: "32px 40px 64px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(145px,1fr))", gap: 12, marginBottom: 28 }}>
          {[
            { lbl: "Median Wage Growth", val: "+55%", sub: "2000 → 2021, nominal", c: "#f0c96a" },
            { lbl: "Conditions Beating It", val: "8 of 10", sub: "outpaced wage growth", c: "#e05c6f" },
      ...
      <div style={{ padding: "40px 40px 64px" }}>
          ...
          <div className="card">
            ...
            {birCosts.map((d, i) => (
              <div key={i} style={{ marginBottom: 14 }}>
                ...
                {d.highlight && (
                  <div style={{ fontSize: 10, color: "#5a2030", marginTop: 3 }}>36× Canada · 3× Germany · 5× Singapore</div>
                )}
              </div>
            ))}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 16, marginBottom: 40 }}>
          ...
          <div className="card" style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            <div style={{ fontSize: 10, color: "#2a2a3a", marginTop: 4 }}>Sources: Berwick et al. 2025 · CDC NCHS · KFF · ACS</div>
          </div>
        </div>
        ...
        <div style={{ borderTop: "1px solid #1a1a2e", paddingTop: 36 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 16 }}>
            {[
              { val: "$5,200", lbl: "more spent per person annually vs. Germany — the next-highest spender", color: "#e05c6f" },
              { val: "~$935B", lbl: "in annual waste that produces no measurable health benefit", color: "#e8855a" },
              { val: "6 years", lbl: "life expectancy gap vs. peer nations, despite highest per-capita spending", color: "#7c6fcd" },
